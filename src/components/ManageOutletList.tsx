...
import ManageOutletCard from './ManageOutletCard'

interface ManageOutletListProps {
  title: string
  outlets: Outlet[]
  emptyListMessage?: string
}

const ManageOutletList: React.FC<ManageOutletListProps> = ({
  title,
  outlets,
          ...
          <View style={{ flexGrow: 1, flexDirection: 'row', minHeight: 2 }}>
            <FlashList
              ...
              renderItem={({ item, index }) => {
                return (
                  <ManageOutletCard key={item.id} outlet={item} index={index} />
                )
              }}
            />
          </View>
...
export default ManageOutletList
